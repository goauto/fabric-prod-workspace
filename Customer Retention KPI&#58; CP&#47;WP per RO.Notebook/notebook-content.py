...
def euclidean_distance(cust_lat, cust_long, dealer_lat, dealer_long):
        ...
        # sqrt of the difference
        distance = np.sqrt(delta_lat**2 + delta_long**2)

        return distance * 111.32  # approximate from degrees to kilometers
...
# Edmonton - Calgary
euclidean_distance(53.450359, -113.583328, 51.055382, -114.082629)
...
# Edmonton - Saskatoon
euclidean_distance(53.450359, -113.583328, 52.115404, -106.656325)
...
# Edmonton - Calgary
haversine(53.450359, -113.583328, 51.055382, -114.082629)
...
# Edmonton - Saskatoon
haversine(53.450359, -113.583328, 52.115404, -106.656325)
...
haversine_distance(53.544278883866774, -113.64092465157549, 53.0168,	-112.8353)
...
def postal_code_to_coordinates(postal_code):
    ...
    result = nomi.query_address(postal_code)
    return pd.Series({
...
postal_code_to_coordinates('T0M 0JO')
